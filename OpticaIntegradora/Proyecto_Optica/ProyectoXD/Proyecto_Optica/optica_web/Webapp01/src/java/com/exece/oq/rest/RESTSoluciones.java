...
public class RESTSoluciones {
    ...
    public Response save(@FormParam("datosSolucion") String jsonSolucion, @FormParam("token") String token) throws Exception {
        ...
        boolean isTokenExist = ce.isToken(token);
    ...
    //Establecemos dentro de los parentesis del metodo los parametros que recibiremos 
    public Response borrarEmpleado(@QueryParam("idProducto") int id, 
                                   @QueryParam("token") @DefaultValue("0") String token) throws Exception {
